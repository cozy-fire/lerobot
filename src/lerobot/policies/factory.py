...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "smolvla_apt":
        return SmolVLAAptConfig(**kwargs)
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, SmolVLAAptConfig):
        from lerobot.policies.smolvla_apt.processor_smolvla_apt import make_smolvla_apt_pre_post_processors

        processors = make_smolvla_apt_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
