...
def make_smolvla_apt_pre_post_processors(
    ...
    """
    Constructs pre-processor and post-processor pipelines for the SmolVLA_APT policy.
    ...
    Args:
        config: The configuration object for the SmolVLA_APT policy.
...
@ProcessorStepRegistry.register(name="smolvla_apt_new_line_processor")
class SmolVLAAptNewLineProcessor(ComplementaryDataProcessorStep):
    """
